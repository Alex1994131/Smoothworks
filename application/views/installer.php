                ...
                <div class="installer-box">
                    ...
                    <div id="installerwizard" class="wizard-box">
                        ...
                        <ul class="bwizard-steps">
                            ...
                            <li class="<?php if ($_GET['step'] == 1) {
                                echo "active";
                            } ?>"> <?php if ($_GET['step'] == 1) { ?> <a href="#" data-toggle="tab"
                                                                         aria-expanded="true"> <?php } ?> <span
                                            class="label">1</span> System Settings <?php if ($_GET['step'] == 1) { ?>
                                </a> <?php } ?>  </li>

                            <li class="<?php if ($_GET['step'] == 2) {
                                echo "active";
                            } ?>"> <?php if ($_GET['step'] == 2) { ?> <a href="#" data-toggle="tab"
                                                                         aria-expanded="true"> <?php } ?> <span
                                            class="label">2</span> Database Settings<?php if ($_GET['step'] == 2) { ?>
                                </a> <?php } ?> </li>

                            <li class="<?php if ($_GET['step'] == 3) {
                                echo "active";
                            } ?>"> <?php if ($_GET['step'] == 3) { ?> <a href="#" data-toggle="tab"
                                                                         aria-expanded="true"> <?php } ?> <span
                                            class="label">3</span> Basic Settings <?php if ($_GET['step'] == 3) { ?>
                                </a> <?php } ?> </li>

                            <li class="<?php if ($_GET['step'] == 4) {
                                echo "active";
                            } ?>"> <?php if ($_GET['step'] == 4) { ?> <a href="#" data-toggle="tab"
                                                                         aria-expanded="true"> <?php } ?> <span
                                            class="label">4</span> Gig Settings <?php if ($_GET['step'] == 4) { ?>
                                </a> <?php } ?> </li>
                        ...
                        <div class="tab-content">
                            ...
                            if ($step1_completed == "true") { ?>
                                ...
                                <div class="tab-pane wizard-content  <?php if ($_GET['step'] == 1) { ?> active <?php } ?>"
                                     id="system_check">

                                    <form class="form-horizontal" id="database_settings" role="form"
                                          action="<?php echo base_url() . "installer/purcahse_code" ?>" method="post"
                                          autocomplete="off">
                                        ...
                                        if (phpversion() > "7.2") {
                                            $error = TRUE;
                                            $php_version_compatibility = FALSE;

                                            echo "<div class='alert alert-danger'>Your PHP version is " . phpversion() . "! PHP 7.2 or Lower required!</div>";
                                        } else {
                                        ...
                                        if (!is_writeable("./assets/temp_files")) {
                                            echo "<div class='alert alert-danger'><i class='fa fa-times'></i> /resource/tmp folder is not writeable!</div>";
                                        } else {
                                            echo "<div class='alert alert-success'><i class='fa fa-check-circle'></i> /assets/temp_files folder is writeable!</div>";
                                        }
                			...
                			<input class="form-control" type="text" required="required" name="purcahse_code" value="">
                                        ...
                                        <ul class="pager wizard">
                                            ...
                                            <?php if ($php_version_compatibility) { ?>
                                                <li class="next">
                            ...
                            <div class="tab-pane wizard-content <?php if ($_GET['step'] == 2) { ?> active <?php } ?>"
                                 id="db_settings">
                                ...
                                if ($step2_completed == "true") { ?>
                                    ...
                                    <form class="form-horizontal" id="database_settings" role="form"
                                          action="<?php echo base_url() . "installer/db_installation" ?>" method="post"
                                          autocomplete="off">
                                        ...
                                        <div class="installer-inputs">
                                            ...
                                            <div class="form-group clearfix">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input class="form-control" type="text" required="required"
                                                           name="hostname" value="<?php if (isset($hostname)) {
                                                        echo $hostname;
                                                    } ?>">
                                            ...
                                            <div class="form-group clearfix">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input class="form-control" type="text" required="required"
                                                           name="db_name" value="<?php if (isset($database_name)) {
                                                        echo $database_name;
                                                    } ?>">
                                            ...
                                            <div class="form-group clearfix">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input class="form-control" type="text" name="db_username"
                                                           required="required" value="<?php if (isset($db_username)) {
                                                        echo $db_username;
                                                    } ?>"/>
                                            ...
                                            <div class="form-group clearfix">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <input class="form-control" type="password" name="db_password"
                                                           value="<?php if (isset($db_password)) {
                                                               echo $db_password;
                                                           } ?>"/>
                            ...
                            <div class="tab-pane wizard-content <?php if ($_GET['step'] == 3) { ?> active <?php } ?> "
                                 id="basic_settings">

                                <form class="form-horizontal" id="admin_basic_details" role="form"
                                      action="<?php echo base_url() . "installer/admin_details" ?>" method="post"
                                      autocomplete="off">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <input class="form-control" required="required"
                                                       value="<?php echo $base_url; ?>" name="base_url" type="text">
                            ...
                            <div class="tab-pane wizard-content <?php if ($_GET['step'] == 4) { ?> active <?php } ?> "
                                 id="gig_settings">

                                <form class="form-horizontal" id="gig_details" role="form"
                                      action="<?php echo base_url() . "installer/gig_details" ?>" method="post"
                                      autocomplete="off">
                                    ...
                                    <div class="installer-inputs">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="default_currency"
                                                        id="default_currency" type="text" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="gigs_payment_option"
                                                        id="gigs_payment_option" type="text" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control numonly" required="required" type="text"
