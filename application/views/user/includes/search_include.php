                ...
                <div class="search-box">
                    <form class="search_form" action="<?php echo base_url() . "search"; ?>" method="post">
                        <div class="row">
                            ...
                            if (!isset($selected_category_value)) {
                                $selected_category_value = '';
                            }
                            $common_search = (!empty($_POST['common_search'])) ? $_POST['common_search'] : '';
                            ?>

                            <input class="text" name="common_search" id="common_search" type="text"
                                   value="<?php echo (!empty($searched_value)) ? $searched_value : $common_search; ?>"
                                   placeholder="<?php echo (!empty($user_language[$user_selected]['lg_search'])) ? $user_language[$user_selected]['lg_search'] : $default_language['en']['lg_search']; ?>"/>
                        </span>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-2">
                                <span class="search-btn">
                                    <button type="submit" name="search_submit" value="search" class="btn btn-primary btn-block search_btn">
