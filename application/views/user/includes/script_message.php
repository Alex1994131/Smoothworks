...
<script type="text/javascript">
    ...
    var account_type = "<?php echo (!empty($user_language[$user_selected]['lg_please_enter_your_account_type'])) ? $user_language[$user_selected]['lg_please_enter_your_account_type'] : $default_language['en']['lg_please_enter_your_account_type']; ?>";
    ...
    var confirm_txt = "<?php echo (!empty($user_language[$user_selected]['lg_confirm'])) ? $user_language[$user_selected]['lg_confirm'] : $default_language['en']['lg_confirm']; ?>";
