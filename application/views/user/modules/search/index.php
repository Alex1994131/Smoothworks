                    ...
                    <div class="col-md-3 col-sm-6 product-cols">
                        ...
                        <div class="product">
                            ...
                            <div class="product-img">
                                ...
                                <a href="<?php echo base_url() . 'gig-preview/' . $gigs['title']; ?>"><img width="240"
                                                                                                           height="250"
                                                                                                           alt="<?php echo $gigs['title']; ?>"
                                    ...
                                    if ($gigs['user_id'] != $user_id) {
                                        ...
                                        if (in_array($gigs['id'], $favorites_list)) { ?>
                                            ...
                                            <div id="favourite_area_list"><a href="javascript:;"
                                                                             ...
                                                                             onclick="remove_favourites_list('<?php echo $gigs['id']; ?>','<?php echo $user_id; ?>', this)"><i
                                                            class="fa fa-heart"></i></a></div>

                                        <?php } else { ?>

                                            <div id="favourite_area_list"><a href="javascript:;" class="favourite"
                                                                             title="Add Favourite"
                                                                             onclick="add_favourites_list('<?php echo $gigs['id']; ?>','<?php echo $user_id; ?>', this)"><i
                                                            class="fa fa-heart"></i></a></div>
