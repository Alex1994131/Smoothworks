            ...
            <div class="col-md-12">
                <div class="search-box">
                    <form onsubmit="return form_submit();" action="<?php echo base_url() . "search"; ?>" method="post">
                        ...
                        <span class="search-input"><input class="text" name="common_search" id="common_search"
                                                          type="text"
                                                          value="<?php if (!empty($searched_value)) {
                                                              echo $searched_value;
                                                          } ?>"
                        ...
                        <span class="search-btn">
										<button type="submit" name="search_submit" value="search"
                                                class="btn btn-primary"><?php echo (!empty($user_language[$user_selected]['lg_search'])) ? $user_language[$user_selected]['lg_search'] : $default_language['en']['lg_search']; ?></button>
									</span>
                    </form>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tab-list">
                    <ul>
                        <li class="active"><a
                                    href="javascript:;"><?php echo (!empty($user_language[$user_selected]['lg_change_password'])) ? $user_language[$user_selected]['lg_change_password'] : $default_language['en']['lg_change_password']; ?></a>
                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="text-right">
                                <div class="row">
                                    <div class="col-lg-3">
                                        <button name="form_submit" class="btn btn-primary btn-block" value="true"
                                                type="submit"><?php echo (!empty($user_language[$user_selected]['lg_save'])) ? $user_language[$user_selected]['lg_save'] : $default_language['en']['lg_save']; ?></button>
                                    </div>
                                </div>
                            </div>
