<div class="">
    ...
    <section class="product-header">
        <div class="container">
            ...
            <script type="text/javascript">
                ...
                var gigs_super_fast_amount = <?php echo (!empty($gig_details['super_fast_charges'])) ? $gig_details['super_fast_charges'] : 0; ?>;
            </script>
            <?php
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="gig-info-list">
                            ...
                            if ($days > 1) {
                                $display_days = $gig_details['delivering_time'] . ' ' . $days;
                            } else {
                                $display_days = $gig_details['delivering_time'] . ' ' . $day;
                            }
                                ...
                                if (($this->session->userdata('SESSION_USER_ID'))) {
                                    ...
                                    if ($gig_user_id == $this->session->userdata('SESSION_USER_ID')) {
                                        ...
                                        if ($already_marked == TRUE) { ?>
                                            <a href="javascript:;"
                                               onclick="remove_favourites('<?php echo $gig_id; ?>','<?php echo $user_id; ?>')">
                                                Saved
                                            </a>
                                        <?php } else { ?>
                                            <a href="javascript:;"
                                               onclick="add_favourites('<?php echo $gig_id; ?>','<?php echo $user_id; ?>')">
                    ...
                    <div class="view-left">
                        <div class="owl-carousel img-carousel">
                            ...
                            foreach ($image_path as $img_path) {
                                ?>
                                <div class="item">
                                    <a href="javascript:;" data-gal="prettyPhoto">
                                        <img class="img-responsive"
                                             src="<?php echo base_url() . $img_path; ?>"
                                             alt="" width="680" height="460"/>
                                    </a>
                                </div>
                            <?php }
                                    ...
                                    if (!in_array($vid_path, $video_array)) {
                                        ...
                                        <div class="item">
                                            <video width="640" height="640" controls>
                                                ...
                                                <source src="<?php echo base_url() . str_replace(".mp4", ".ogg", $vid_path); ?>"
                                                        type="video/ogg">
                        ...
                        <div class="gig-information">
                            <h3 class="gig-desc-title">
                                <?php echo (!empty($user_language[$user_selected]['lg_description'])) ? $user_language[$user_selected]['lg_description'] : $default_language['en']['lg_description']; ?>
                            </h3>
                                                        ...
                                                        <div class="delivery-block clearfix">
                                                            <div class=" checkbox-primary checkbox-inline pull-left">
                                                                <input type="checkbox" class="check_box"
                                                                       id="<?php echo $count; ?>" value="">
                                                                <label for="check1">&nbsp; </label>
                                                            </div>
                                                            <span class="extras-cont"><?php echo ucfirst($extra_gigs['extra_gigs']); ?></span>
                                                            <input type="hidden"
                                                                   id="extra_gig_desc_<?php echo $count; ?>"
                                                                   value="<?php echo $extra_gigs['extra_gigs']; ?>"/>

                                                            <input type="hidden"
                                                                   id="extra_gig_input_<?php echo $count; ?>" value=""
                                                                   class="form-control">

                                                            <input type="hidden" name="extra_gigs_amount"
                                                                   id="extra_gigs_amount_<?php echo $count; ?>"
                                                                   class="form-control price_list"
                                                                   value="<?php echo $extra_gig_price; ?>">
                                                            ...
                                                            <span class="extra-input pull-right">
                                                                ...
                                                                <span class="currency_symbol"><?php echo $rate_symbol . $extra_gig_price; ?></span>

                                                                <input type="hidden"
                                                                       id="default_value_<?php echo $count; ?>"
                                                                       value="<?php echo $extra_gig_price; ?>">

                                                                <input type="hidden"
                                                                       id="default_extra_gigs_delivery_<?php echo $count; ?>"
                                                                ...
                                                                <span class="delivery_days">	<?php echo "" . $extra_gigs['extra_gigs_delivery'];
                                            ...
                                            if (strtolower($gig_details['super_fast_delivery']) == 'yes') {
                                                ...
                                                <li>
                                                    <div class="delivery-block clearfix">
                                                        ...
                                                        <span id="super_fast_delivery_desc" class="extras-cont">
                                                            <?php if ($gig_details['super_fast_delivery_desc']) {
                                                                echo $gig_details['super_fast_delivery_desc'];
                                                            } ?>
                                                        </span>
                                                        <input type="hidden" name="super_fast_charges" id="super_fast_delivery_charges" class="form-control price_list"
                                                               value="<?php echo $extra_gig_price; ?>" disabled>
                                                        <span class="extra-input pull-right">
                                                            <?php echo (!empty($user_language[$user_selected]['lg_for'])) ? $user_language[$user_selected]['lg_for'] : $default_language['en']['lg_for']; ?>
                                                            <span class="currency_symbol"><?php echo $rate_symbol . $extra_gig_price; ?></span>

                                                            <input type="hidden" name="super_fast_delivery_date"
                                                                   id="super_fast_delivery_date"

                                                                   value="<?php if ($gig_details['super_fast_delivery_date']) {
                                                                       echo $gig_details['super_fast_delivery_date'];
                                                                   } ?> "/>

                                                            <?php echo (!empty($user_language[$user_selected]['lg_in'])) ? $user_language[$user_selected]['lg_in'] : $default_language['en']['lg_in']; ?>
                                                            <span class="delivery_days">

                                                             <?php if ($gig_details['super_fast_delivery_date'] == 1) {
                                                                 echo $gig_details['super_fast_delivery_date'] . " day";
                                                             } else {
                                                             ...
                                                             <span class="gig-amount pull-right"></span>
                                                        </span>
                                                    </div>
                                                </li>
                                                <?php
                                        ...
                                        <ul class="extras-list extra_gig_list">
                                            ...
                                            if (!empty($result)) {
                                                foreach ($result as $extra_gigs) {
                                                    ...
                                                    <li>
                                                        <div class="delivery-block clearfix">
                                                            <div class=" checkbox-primary checkbox-inline pull-left"></div>
                                                            <span class="extras-cont"><?php echo ucfirst($extra_gigs['extra_gigs']); ?></span>
                                                            ...
                                                            <span class="extra-input pull-right">
                                                                ...
                                                                <?php echo (!empty($user_language[$user_selected]['lg_in'])) ? $user_language[$user_selected]['lg_in'] : $default_language['en']['lg_in']; ?>
                                                                <span class="delivery_days">
                                                                    <?php echo "" . $extra_gigs['extra_gigs_delivery'];
                                                                    if ($extra_gigs['extra_gigs_delivery'] == 1) {
                                                                        echo " day";
                                                                    } else {
                                                                        echo " days";
                                            ...
                                            if (strtolower($gig_details['super_fast_delivery']) == 'yes') { ?>
                                                <li>
                                                    <div class="delivery-block clearfix">
                                                        ...
                                                        <span class="extra-input pull-right">
                                                            <?php echo (!empty($user_language[$user_selected]['lg_for'])) ? $user_language[$user_selected]['lg_for'] : $default_language['en']['lg_for']; ?>
                                                            <span class="currency_symbol"><?php echo $rate_symbol . $gig_details['super_fast_charges']; ?></span>
                                                            <input type="hidden" name="super_fast_delivery_date"
                                                                   id="super_fast_delivery_date"
                                                                   value="<?php if ($gig_details['super_fast_delivery_date']) {
                                                                       echo $gig_details['super_fast_delivery_date'];
                                                            ...
                                                            <?php echo (!empty($user_language[$user_selected]['lg_in'])) ? $user_language[$user_selected]['lg_in'] : $default_language['en']['lg_in']; ?>
                                                            <span class="super-fast-delivery super-del">
                    ...
                    <div class="view-right">
                            ...
                            <?php if (($this->session->userdata('SESSION_USER_ID'))) {
                                if (($this->session->userdata('SESSION_USER_ID')) == $user_profile['USERID']) {
                                    if ($my_account_type == 1) {
                                        ?>
                                        <a href="<?php echo base_url() . "edit-gigs/" . $gig_details['title']; ?>" class="btn">
                                            <?php echo (!empty($user_language[$user_selected]['lg_edit_gig'])) ? $user_language[$user_selected]['lg_edit_gig'] : $default_language['en']['lg_edit_gig']; ?>
                                        </a>
                                    <?php }
                                }
                            } ?>
                            ...
                            <div class="seller-info2">
                                ...
                                <ul class="gig-stats seller-stats">
                                    <li class="media seller-det">
                                        ...
                                        <a href="<?php echo base_url() . "user-profile/" . $username; ?>" class="">
                                            <img width="50" height="50" alt="" class="seller-img" src="<?php echo $user_image; ?>">
                                        </a>
                                        ...
                                        <div class="media-body">
                                            <span class="seller-name-section">
                                                <span class="seller-name">
                                                    ...
                                                    <span class="seller-position text-ellipsis">
                                                        <?php if (!empty($user_profile['profession_name'])) {
                                                            echo $user_profile['profession_name'];
                                                        } ?>
                                                    </span>
                                                </span>
                                            </span>
                                            <div class="seller-country">
                                                <span class="ppcn country <?php echo $user_country_shortname; ?>"></span>
                                                <?php echo $user_country_name; ?>
                                            </div>
                                    ...
                                    <?php if (($this->session->userdata('SESSION_USER_ID')) != $user_profile['USERID']) { ?>
                                        ...
                                        <li class="seller-contact">
                                            <img alt="views" src="<?php echo base_url() . "assets/images/contact.png"; ?>" width="33" height="33">
                                            <?php if (($this->session->userdata('SESSION_USER_ID'))) { ?>
                                                <a href="#" data-toggle="modal" data-target="#message-popup">
                                                    <h5><?php echo (!empty($user_language[$user_selected]['lg_contact_seller'])) ? $user_language[$user_selected]['lg_contact_seller'] : $default_language['en']['lg_contact_seller']; ?></h5>
                                                </a>
                                            <?php } else { ?>
                        ...
                        <div class="seller-info">
                            <ul class="gig-stats seller-stats">
                                <li class="seller-views">
                                    <img alt="views" src="<?php echo base_url() . "assets/images/view.png" ?>" width="34" height="34">
                                    <h5><?php echo $gig_details['total_views']; ?><?php echo (!empty($user_language[$user_selected]['lg_views'])) ? $user_language[$user_selected]['lg_views'] : $default_language['en']['lg_views']; ?></h5>
                                </li>

                                <li class="seller-speaks">
                                    <img alt="views" src="<?php echo base_url() . "assets/images/speaks.png"; ?>" width="34" height="34">
                                    <h5>
                                ...
                                if (!empty($gig_tags)) { ?>
                                    <li class="related-topics">
                                        ...
                                        <p class="tags">
                                            ...
                                            foreach ($tags as $tag) { ?>
                                                <a href="javascript:;"><?php echo ucfirst($tag); ?></a>
                                            <?php }
                                            ?>
                                        </p>
                        ...
                        <?php if (!empty($category_based_gigs)) { ?>
                            <div class="similiar-gigs">
                                ...
                                <h3><?php echo (!empty($user_language[$user_selected]['lg_similar_gigs'])) ? $user_language[$user_selected]['lg_similar_gigs'] : $default_language['en']['lg_similar_gigs']; ?>
                                    <span class="similar-gig-all">
                                        <a href="<?php echo base_url() . "search/category/" . $similar_gigs; ?>"> <?php echo (!empty($user_language[$user_selected]['lg_see_all'])) ? $user_language[$user_selected]['lg_see_all'] : $default_language['en']['lg_see_all']; ?> </a>
                                    </span>
                                </h3>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h4 class="media-heading">
                                                    <a href="<?php echo base_url() . 'gig-preview/' . $cat['title']; ?>"><?php echo ucfirst(str_replace("-", " ", $cat['title'])); ?></a>
                                                </h4>

                                                <div class="feed-rating feedback-area">
                                                    <span class="starrr" data-rating="<?php echo $rat_gig; ?>"></span>
                                                </div>
                                                <div class="price"><span><?php echo $rate_symbol . $rate; ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
    ...
    <div class="page-section">
        <?php if (!empty($user_all_gigs)) { ?>
            <div class="container">
                <h2 class="other-gigs-title">Other gigs <span>by
                    <a href="<?php echo base_url() . 'user-profile/' . $username; ?>"><?php echo $user_name; ?></a></span>
                </h2>
                        ...
                        foreach ($user_all_gigs as $gigs) {
                            ...
                            <div class="product">
                                <div class="product-img">
                                    <a href="<?php echo base_url() . 'gig-preview/' . $gigs['title']; ?>">
                                        <img width="240" height="250" alt="<?php echo $gigs['title']; ?>" src="<?php echo $image; ?>">
                                    </a>
                                </div>

                                <div class="product-detail">
                                    <div class="product-name">
                                        <a href="<?php echo base_url() . 'gig-preview/' . $gigs['title']; ?>"><?php echo ucfirst(str_replace("-", " ", $gigs['title'])); ?></a>
                                    </div>

                                    <div class="author">
                                        <span class="author-img">
											<a href="<?php echo base_url() . 'user-profile/' . $gigs['username']; ?>">
                                                <img src="<?php echo $user_img; ?>" title="<?php echo $gigs['fullname']; ?>" width="50" height="50">
                                            </a>
											<a href="<?php echo base_url() . 'user-profile/' . $gigs['username']; ?>"><?php echo $gigs['fullname']; ?></a>
                                        </span>
                                        <div class="ratings">
                                            <span class="stars-block star-<?php echo $gig_rating; ?>"></span>
                                            <span class="ratings-count">(<?php echo $gig_usercount; ?>)</span>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="quantity-list">
                                <li>
                                    <div class="form-group clearfix">
                                        ...
                                        <label class="label-title">
                                            <?php echo (!empty($user_language[$user_selected]['lg_price'])) ? $user_language[$user_selected]['lg_price'] : $default_language['en']['lg_price']; ?>
                                        </label>
                                ...
                                <li>
                                    <span class="multiple"><i aria-hidden="true" class="fa fa-times"></i></span>
                                </li>
                                <li>
                                    <div class="form-group clearfix">
                                        <label class="label-title">
                        ...
                        <div class="col-md-6">
                            <div class="text-right summary">
                                <span class="price-tag"> <?php echo $rate_symbol; ?>
                                    <span id="change_ratecount"><?php echo $rate; ?></span>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="<?php echo base_url() . 'user/gigs/payment'; ?>" method="post" id="payment_formid" name="payment_submit">
                        ...
                        <input type="hidden" name="currency_type" id="currency_type" value="<?php echo $gig_details['currency_type']; ?>"/>
                        ...
                        <div id="payment-method">
                            ...
                            <div class="payment-method">
                                ...
                                <?php if ($paytabs_allow == 1) {  ?>
                                    <label class="radio-inline bold">
                                        <input class="le-radio" type="radio" onchange="check_payment_type(this)" name="group2" value="paytab"> PayTabs
                                    </label>
                                <?php }  ?>

                                <?php if ($stripe_allow == 1) { ?>
                                    <label class="radio-inline bold">
                                        <input class="le-radio" type="radio" onchange="check_payment_type(this)" name="group2" value="stripe">
                                        <?php echo (!empty($user_language[$user_selected]['lg_stripe'])) ? $user_language[$user_selected]['lg_stripe'] : $default_language['en']['lg_stripe']; ?>
                                    </label>
                                <?php } ?>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <div class="msg-user-details">
                        ...
                        <div class="pull-left user-img m-r-10">
                            <img src="<?php echo $user_image; ?>" alt="" class="w-40 img-circle" width="50" height="50">
                    ...
                    <div class="new-message">
                        ...
                        <form id="form_messagecontent_id" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="to_user_id" id="to_user_id" value="<?php echo $user_profile['USERID']; ?>"/>
                            <input type="hidden" name="to_user_name" id="to_user_name" value="<?php echo $user_profile['fullname']; ?>"/>
                            <input type="hidden" name="to_user_avatar" id="to_user_avatar" value="<?php echo $user_profile['user_thumb_image']; ?>"/>
                            <div class="form-group">
                                ...
                                <textarea name="chat_message_content" placeholder="Message to <?php echo $name; ?>"
                                          required="" id="messageone" class="form-control"></textarea>
                            </div>
                        </form>
                    </div>
