            ...
            <div class="col-md-12">
                <h3 class="header-title">
                    ...
                    <span>
                        ...
                        <?php echo (!empty($user_language[$user_selected]['lg_gigs_found'])) ? $user_language[$user_selected]['lg_gigs_found'] : $default_language['en']['lg_gigs_found']; ?>
                    </span>
                </h3>
            </div>
        </div>
                    ...
                    <div class="col-md-3 col-sm-6 product-cols">
                        <div class="product">
                            <div class="product-img">
                                <?php
                                    if($gigs['exist_flag'] == 1) {
                                ?>
                                <a href="#" onclick="alert('you can not get this services because this is block services');">
                                ...
                                <?php if (($this->session->userdata('SESSION_USER_ID'))) {
                                    $user_id = $this->session->userdata('SESSION_USER_ID');
                                    if($my_account_type == 2 || $gigs['exist_flag'] == 0 ) {
                                        if ($gigs['user_id'] != $user_id) {

                                            if (in_array($gig_idone, $favorites_list)) { ?>
                                                <div id="favourite_area_list">
                                                    <a href="javascript:;" class="favourite favourited" title="Remove Favourite" onclick="remove_favourites_list('<?php echo $gig_idone; ?>','<?php echo $user_id; ?>', this)">
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <div id="favourite_area_list">
                                                    <a href="javascript:;" class="favourite" title="Add Favourite" onclick="add_favourites_list('<?php echo $gig_idone; ?>','<?php echo $user_id; ?>', this)">
                                                        <i class="fa fa-heart"></i>
                                                    </a>
                                                </div>
                                            <?php }
                            ...
                            <div class="product-detail">
                                ...
                                <div class="product-name">
                                    <?php
                                        if($gigs['exist_flag'] == 1) {
                                    ?>
                                    <a href="#" onclick="alert('you can not get this services because this is block services');"><?php echo ucfirst(str_replace("-", " ", $gigs['title'])); ?></a>
                                    <?php
                                        } else {
                                    ?>
												...
												<span class="author-img">
													...
													<a href="#" onclick="alert('you can not get this services because this is block services');">
                                                        <img src="<?php echo $user_img; ?>"
                                                                title="<?php echo $gigs['fullname']; ?>" alt=""
                                                                width="50" height="50">
                                                    </a>

													<a class="author-name" onclick="alert('you can not get this services because this is block services');" href="#"><?php echo ucfirst($name); ?></a>
                                                    <?php
                                                    }
                                                    else {
                                                    ?>
                                                    <a href="<?php echo base_url() . "user-profile/" . $username; ?>">
                                                        <img src="<?php echo $user_img; ?>"
                                                             title="<?php echo $gigs['fullname']; ?>" alt=""
                                                             width="50" height="50">
                                                    </a>
