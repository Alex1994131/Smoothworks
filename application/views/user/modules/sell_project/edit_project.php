...
$price = $project_details['project_price'];
$day = $project_details['delivering_time'];
$tag = $project_details['project_tags'];
$category = $project_details['category_id'];
$detail = $project_details['project_details'];

if($project_details['file_paths'] != '')
{
    $file_list = explode('#', $project_details['file_paths']);
}
else{
    $file_list = NULL;
}
        ...
        <div class="row">
            <div class="col-md-8 col-sm-12">
                <h3 class="post-gig-title">
                    <?php echo (!empty($user_language[$user_selected]['lg_post_a_project_in_few_seconds'])) ? $user_language[$user_selected]['lg_post_a_project_in_few_seconds'] : $default_language['en']['lg_post_a_project_in_few_seconds']; ?>
                </h3>
                <p class="sub-title"></p>
                ...
                <form id="project" action="<?php echo base_url() . "save-project"; ?>" method="post" class="sell-service-form" enctype="multipart/form-data">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="name-block">
            				<span class="name-input">
								<input type="text" name="project_title" id="project_title" value="<?php echo $title?>" class="form-control gig-name " maxlength="80" placeholder="<?php echo (!empty($user_language[$user_selected]['lg_require_a_website'])) ? $user_language[$user_selected]['lg_require_a_website'] : $default_language['en']['lg_require_a_website']; ?>">
							</span>
                            <span class="currency">
                                ...
                                <span class="currency-group">
                                    ...
                                    <input type="text" class="form-control amount numberonly" name="project_price" onfocusout="inputfocusout(this)" id="project_price" value="<?php echo $price; ?>">
								</span>
							</span>
                        </div>
                    ...
                    <div class="form-group clearfix delivery-day">
                        <label class="label-title"><?php echo (!empty($user_language[$user_selected]['lg_how_many_days_are_you_demand'])) ? $user_language[$user_selected]['lg_how_many_days_are_you_demand'] : $default_language['en']['lg_how_many_days_are_you_demand']; ?>
                        ...
                        <input type="text" name="delivering_time" id="delivering_time" class="form-control"
                               ...
                               placeholder="<?php echo (!empty($user_language[$user_selected]['lg_just_type_number_of_days'])) ? $user_language[$user_selected]['lg_just_type_number_of_days'] : $default_language['en']['lg_just_type_number_of_days']; ?> (<?php echo (!empty($user_language[$user_selected]['lg_ex'])) ? $user_language[$user_selected]['lg_ex'] : $default_language['en']['lg_ex']; ?>: 2 <?php echo (!empty($user_language[$user_selected]['lg_days'])) ? $user_language[$user_selected]['lg_days'] : $default_language['en']['lg_days']; ?>)" value="<?php echo $day;?>">
                        ...
                        <small class="error_msg help-block delivery_days_error"
                           style="display: none;"><?php echo (!empty($user_language[$user_selected]['lg_please_enter_a_days_1_to_29'])) ? $user_language[$user_selected]['lg_please_enter_a_days_1_to_29'] : $default_language['en']['lg_please_enter_a_days_1_to_29']; ?>.
                        </small>
                    </div>
                    <div class="form-group clearfix">
                            ...
                            <select class="select gig-category" id="project_category_id" name="project_category_id">
                                ...
                                <?php foreach ($categories_subcategories as $cat) {
                                    if ($cat['parent'] == 0) {
                                        ...
                                        ?>
                                        <option class="categoryselected category_main_menu" value="<?php echo $cat['CATID']; ?>" <?php echo $cat['CATID'] == $category ? 'selected' : ''?>> <?php echo $cat['name']; ?> </option>
                                <?php
                                        if ($result_count > 0) {
                                            foreach ($result as $sub_category_list) { ?>
                                                <option class="sub_category_menu" value="<?php echo $sub_category_list['CATID']; ?>" <?php echo $sub_category_list['CATID'] == $category ? 'selected' : ''?>> <?php echo $sub_category_list['name']; ?> </option>
                                            <?php }
                                        }
                                    }
                                }
                    ...
                    <div class="form-group clearfix">
                        ...
                        <input type="text"
                           ...
                           name="project_tags" id="project_tags" data-role="tagsinput" class="form-control" value="<?php echo $tag?>">
                    </div>
                    <div class="form-group clearfix">
                        <label class="label-title">
                        ...
                        <?php
                            foreach($file_list as $file)
                            {
                                ...
                                <div class="attach-block">
                                    <a href="<?php echo base_url(). $file ?>" attach_name="<?php echo $file?>" download><i class="fa fa-paperclip"></i> <?php echo array_pop(explode('/',$file)); ?></a>
                                    <label class="sos-switch" onchange="change_file(this)">
                                        <input type="checkbox" checked>
                                        <span class="sos-slider sos-round"></span>
                                    </label>
                                </div>
                                <?php
                            }
                        ...
                        <div class="file-upload-block" ondrop="dropHandler(event);" ondragover="dragOverHandler(event);">
                    ...
                    <div class="form-group item-description clearfix">
                        <label class="label-title"><?php echo (!empty($user_language[$user_selected]['lg_provide_more_details_about_your_project'])) ? $user_language[$user_selected]['lg_provide_more_details_about_your_project'] : $default_language['en']['lg_provide_more_details_about_your_project']; ?>
                            <span class="required">*</span>
                        </label>
                        <textarea rows="5"
                          ...
                          name="project_details" id="project_details" class="form-control" ><?php echo $detail?></textarea>
                    ...
                    <a href="javascript:void(0)" onclick="edit_projects_save()" class="btn btn-yellow sell_service_submit">
                        <?php echo (!empty($user_language[$user_selected]['lg_post_your_project'])) ? $user_language[$user_selected]['lg_post_your_project'] : $default_language['en']['lg_post_your_project']; ?>
                    </a>
                </form>
            </div>
