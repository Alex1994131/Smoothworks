                    ...
                    <div class="user-details">
                        ...
                        <div class="user-contact">
                            <ul class="list-inline">
                                ...
                                ?>
                                <li class="user-rating feedback-area"><span id="stars-existing" class="starrr"
                                                                            data-rating="<?php echo $rat; ?>"> </span>(<?php echo $rat_count; ?>
                                    )
                                </li>
                                <?php if (!empty($country_name)) { ?>
                                    <li class="user-country2"><?php echo (!empty($user_language[$user_selected]['lg_from'])) ? $user_language[$user_selected]['lg_from'] : $default_language['en']['lg_from']; ?> <?php echo $country_name; ?>
                                        <span class="ppcn country <?php echo $country_shortname; ?>"></span>
                                    </li> <?php } ?>
                            </ul>
                        </div>
                        <div class="user-description">
                            <p class="user-desc"> <?php echo ucfirst($profile['description']); ?> <span
                                        class="more-desc"></span></p>
                        </div>
                        <?php if (!empty($profile['language'])) { ?>
                            ...
                            <div class="user-language">
                                ...
                                : <span id="language_list"><?php echo ucfirst($profile['language']); ?></span>
                        ...
                        <div class="col-md-9 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>
                                            <?php echo (!empty($user_language[$user_selected]['lg_phone'])) ? $user_language[$user_selected]['lg_phone'] : $default_language['en']['lg_phone']; ?>:
                                        </label>
                                        <input type="text" name="phone" id="phone" class="form-control" value="<?php echo $profile['phone']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group clearfix">
                                        ...
                                        <input type="text" name="language_tags" id="tokenfield" class="form-control" value="<?php echo ucfirst($profile['language']); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>
                                            <?php echo (!empty($user_language[$user_selected]['lg_something_about_you'])) ? $user_language[$user_selected]['lg_something_about_you'] : $default_language['en']['lg_something_about_you']; ?>:
                                        </label>
