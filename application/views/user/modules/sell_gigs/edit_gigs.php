...
<section class="post-gig-area">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <h3 class="post-gig-title">
                    <?php echo (!empty($user_language[$user_selected]['lg_post_a_gig_in_few_seconds'])) ? $user_language[$user_selected]['lg_post_a_gig_in_few_seconds'] : $default_language['en']['lg_post_a_gig_in_few_seconds']; ?>
                </h3>

                <p class="sub-title">
                    <?php echo (!empty($user_language[$user_selected]['lg_gig'])) ? $user_language[$user_selected]['lg_gig'] : $default_language['en']['lg_gig']; ?>
                    : <?php echo (!empty($user_language[$user_selected]['lg_a_packed_service_you_can_deliver_remotely_or__around_you_for_a_fixed_price_in_a_set_time_frame'])) ? $user_language[$user_selected]['lg_a_packed_service_you_can_deliver_remotely_or__around_you_for_a_fixed_price_in_a_set_time_frame'] : $default_language['en']['lg_a_packed_service_you_can_deliver_remotely_or__around_you_for_a_fixed_price_in_a_set_time_frame']; ?>.
                </p>
                ...
                <form id="update_gig" action="<?php echo base_url() . "save-gigs"; ?>" method="post" class="sell-service-form" enctype="multipart/form-data">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <label class="label-title">
                            <?php echo (!empty($user_language[$user_selected]['lg_title_for_your_gig'])) ? $user_language[$user_selected]['lg_title_for_your_gig'] : $default_language['en']['lg_title_for_your_gig']; ?>
                            <span class="required">*</span>
                        </label>

                        <div class="name-block">
							<span class="name-input">
								<input type="text" name="gig_title" id="gig_title" onkeyup="gig_title_check(this)"
                                       onchange="gig_title_check(this)"
                                       value="<?php echo str_replace('-', ' ', $basic_details['title']); ?>"
                                       class="form-control gig-name" maxlength="80" placeholder="I can">
                            ...
                            <span class="currency">
                                ...
                                <span class="currency-group">
                                    ...
                                    <input type="text"
                                       class="form-control amount numberonly"
                                       onfocusout="inputfocusout(this)"
                                       name="gig_price"
                                       id="edit_gig_price" <?php echo ($allow == 1) ? '' : 'readonly'; ?> value="<?php echo $rate; ?>">
								</span>
							</span>
                        </div>

                        <span class="form-description">
                            <?php echo (!empty($user_language[$user_selected]['lg_eg'])) ? $user_language[$user_selected]['lg_eg'] : $default_language['en']['lg_eg']; ?>. <?php echo (!empty($user_language[$user_selected]['lg_i_can_repair_a_door_in_paris'])) ? $user_language[$user_selected]['lg_i_can_repair_a_door_in_paris'] : $default_language['en']['lg_i_can_repair_a_door_in_paris']; ?>
                        </span>

                        <small class="error_msg help-block gig_title_error" style="display: none;">
                        ...
                        <small class="error_msg help-block gig_title_already_error" style="display: none;">
                        ...
                        <small class="error_msg help-block gig_price_error" style="display: none;">
                            <?php echo (!empty($user_language[$user_selected]['lg_please_enter_the_price_for_gig'])) ? $user_language[$user_selected]['lg_please_enter_the_price_for_gig'] : $default_language['en']['lg_please_enter_the_price_for_gig']; ?>
                        </small>
                    ...
                    <div class="form-group delivery-day clearfix">
                        <label class="label-title">
                            <?php echo (!empty($user_language[$user_selected]['lg_when_will_you_deliver_the_gig'])) ? $user_language[$user_selected]['lg_when_will_you_deliver_the_gig'] : $default_language['en']['lg_when_will_you_deliver_the_gig']; ?>
                            ? <span class="required">*</span>
                        </label>

                        <input type="text" name="delivering_time" id="delivering_time" class="form-control"
                               value="<?php echo $basic_details['delivering_time']; ?>" maxlength="2"
                               onkeyup="max_lenght(this)"
                        ...
                        <span id="main_delivery_days" class="actual_delivery_days">
                            <?php if ($basic_details['delivering_time'] == 1) {
                                echo " Day ";
                            } else {
                                echo " Days";
                            } ?>
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="category-select">
                            <select class="select gig-category" id="gig_category_id" name="gig_category_id">
                                <option value="">
                                    --<?php echo (!empty($user_language[$user_selected]['lg_select'])) ? $user_language[$user_selected]['lg_select'] : $default_language['en']['lg_select']; ?>
                                    --
                                </option>
                                <?php
                                foreach ($categories_subcategories as $cat) {
                                    if ($cat['parent'] == 0) {
                                        ...
                                        <option class="category_main_menu" value="<?php echo $cat['CATID']; ?>" <?php if ($cat['CATID'] == $basic_details['category_id']) echo "Selected"; ?> >
                                            <?php echo $cat['name']; ?>
                                        </option>
                                        <?php
                                        if ($result_count > 0) {
                            ...
                            <small class="error_msg help-block gig_category_id_error" style="display: none;">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <input type="text" placeholder="Enter your tags" name="gig_tags" id="gig_tags"
                               data-role="tagsinput" value="<?php echo $basic_details['gig_tags']; ?>"
                               class="form-control">
                    </div>
                    ...
                    <div class="form-group add-image clearfix">
                        ...
                        <label class="label-title"><?php echo (!empty($user_language[$user_selected]['lg_make_it_fun'])) ? $user_language[$user_selected]['lg_make_it_fun'] : $default_language['en']['lg_make_it_fun']; ?>
                            :<?php echo (!empty($user_language[$user_selected]['lg_upload_photos_or_videos'])) ? $user_language[$user_selected]['lg_upload_photos_or_videos'] : $default_language['en']['lg_upload_photos_or_videos']; ?>!
                        </label>
                    ...
                    <div class="form-group clearfix uploaded-section">
                        ...
                        if ($gig_image_details) {
                            ...
                            foreach ($gig_image_details as $gig_images) {
                                ...
                                <div id="remove_image_div_<?php echo $row_id; ?>" class="uploaded-img">
                                    <img height="68" width="100" class="imageThumb"
                                         src="<?php echo base_url() . $gig_images['gig_image_tile']; ?> "
                                         title="images"/>

                                    <a onclick="update_gig(<?php echo $gig_images['id']; ?>,'<?php echo $gig_images['gig_image_tile']; ?>','<?php echo $row_id; ?>','image')"
                                       href="javascript:;" class="uploaded-remove pull-right">
                            ...
                            foreach ($gig_video_details as $gig_video) {
                                ...
                                <div id="remove_video_div_<?php echo $vedio_row_id; ?>" class="uploaded-img">
                                    <video class="img-responsive" style="height:100px !important; ">
                                        ...
                                        "
                                        <source src="<?php echo base_url() . $gig_video['video_path'] ?>" ;
                        ...
                        <small class="error_msg help-block image_error_error" style="display: none;">
                            <?php echo (!empty($user_language[$user_selected]['lg_please_upload_a_file'])) ? $user_language[$user_selected]['lg_please_upload_a_file'] : $default_language['en']['lg_please_upload_a_file']; ?>
                        </small>
                    </div>

                    <div class="form-group item-description clearfix">
                        <label class="label-title">
                            <?php echo (!empty($user_language[$user_selected]['lg_provide_more_details_about_your_gig'])) ? $user_language[$user_selected]['lg_provide_more_details_about_your_gig'] : $default_language['en']['lg_provide_more_details_about_your_gig']; ?>
                            <span class="required">*</span>
                        </label>
                        <textarea rows="5"
                          placeholder="<?php echo (!empty($user_language[$user_selected]['lg_explain_in_more_detail_what_exactly_you_will_deliver_to_the_buyer'])) ? $user_language[$user_selected]['lg_explain_in_more_detail_what_exactly_you_will_deliver_to_the_buyer'] : $default_language['en']['lg_explain_in_more_detail_what_exactly_you_will_deliver_to_the_buyer']; ?>..."
                          name="gig_details" id="gig_details"
                          class="form-control"> <?php echo $basic_details['gig_details']; ?>
                        </textarea>
                        <?php echo display_ckeditor($ckeditor_editor); ?>

                        <span class="error_msg help-block" id="desc_err"></span>
                        <small class="error_msg help-block gig_details_error" style="display: none;">
                            <?php echo (!empty($user_language[$user_selected]['lg_please_enter_about_your_gig_details'])) ? $user_language[$user_selected]['lg_please_enter_about_your_gig_details'] : $default_language['en']['lg_please_enter_about_your_gig_details']; ?>
                        </small>
                    </div>

                    <div class="form-group clearfix">
                        <label class="label-title">
                            <?php echo (!empty($user_language[$user_selected]['lg_earn_extra_money'])) ? $user_language[$user_selected]['lg_earn_extra_money'] : $default_language['en']['lg_earn_extra_money']; ?>
                            - <?php echo (!empty($user_language[$user_selected]['lg_offer_optional_add'])) ? $user_language[$user_selected]['lg_offer_optional_add'] : $default_language['en']['lg_offer_optional_add']; ?>
                            -<?php echo (!empty($user_language[$user_selected]['lg_on_services_to_the_buyer'])) ? $user_language[$user_selected]['lg_on_services_to_the_buyer'] : $default_language['en']['lg_on_services_to_the_buyer']; ?>
                        </label>
                        ...
                        <div class="add-more-items clearfix">
                            ...
                            if (!empty($extra_gig_details)) {
                                foreach ($extra_gig_details as $extra_gigs) {
                                    ...
                                    <div class="clearfix extra-gig-option" id="row_id_<?php echo $iteration_value; ?>">
                                        <span class="close-offer">
                                            <i class="fa fa-times" onclick="remove_edit_gig_div(<?php echo $iteration_value; ?>);" aria-hidden="true"></i>
                                        </span>

                                        <div class="name-block2">
								            <span class="name-input2">
                                                <input type="text" name="extra_gigs[]"
                                                       id="label_name_<?php echo $iteration_value; ?>"
                                                       value="<?php echo $extra_gigs['extra_gigs']; ?>"
                                                       class="form-control gig-name extra_money_price" placeholder="I can"
                                                       date-no="<?php echo $iteration_value; ?>">
					                        </span>
                                            <span class="currency">
                                                <?php echo (!empty($user_language[$user_selected]['lg_for'])) ? $user_language[$user_selected]['lg_for'] : $default_language['en']['lg_for']; ?>
                                                <span class="currency-group">
                                                    <?php echo $rate_symbol; ?>
                                                    <input type="text" class="form-control amount numberonly" name="extra_gigs_amount[]"
                                                        id="label_val_<?php echo $iteration_value; ?>" <?php echo ($allow == 1) ? '' : 'readonly'; ?> onfocusout="inputfocusout(this)"
                                                        value="<?php echo $ex_price = $rate; ?>">

                                                </span>
                                                <?php echo (!empty($user_language[$user_selected]['lg_in'])) ? $user_language[$user_selected]['lg_in'] : $default_language['en']['lg_in']; ?>
                                                <input
                                                    type="text"
                                                    value="<?php echo $extra_gigs['extra_gigs_delivery']; ?>"
                                                    class="form-control amount2 numberonly"
                                                    onkeyup="extra_gig_days(this,1)"
                                                    onmouseup="extra_gig_days(this,1)" name="extra_gigs_delivery[]">

                                               <span class="sub_delivery_days">
                                                   <?php echo (!empty($user_language[$user_selected]['lg_day'])) ? $user_language[$user_selected]['lg_day'] : $default_language['en']['lg_day']; ?>
                                               </span>
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div class="clearfix extra-gig-option" id="row_id_1">
                                    <span class="close-offer">
                                        <i class="fa fa-times" onclick="remove_div(1);" aria-hidden="true"></i>
                                    </span>
                                    <div class="name-block2">
                                        <span class="name-input2">
                                            <input type="text" name="extra_gigs[]" value=""
                                                 id="label_name_1"
                                                 class="form-control gig-name extra_money_price"
                                                 placeholder="I can" date-no="1">
                                        </span>
                                        ...
                                        <span class="currency">
                                            ...
                                            <span class="currency-group">
		                                        <?php echo $rate_symbol; ?>
                                                <input type="text" class="form-control amount numberonly" id="label_val_1"
                                                   name="extra_gigs_amount[]"
                                                   onfocusout="inputfocusout(this)"  <?php echo ($allow == 1) ? '' : 'readonly'; ?> value="<?php echo $ex_price = $rate; ?>">

                                            </span>
                                            <?php echo (!empty($user_language[$user_selected]['lg_in'])) ? $user_language[$user_selected]['lg_in'] : $default_language['en']['lg_in']; ?>
                                            <input
                                                type="text" value="1" class="form-control amount2 numberonly"
                                                onkeyup="extra_gig_days(this,1)" onmouseup="extra_gig_days(this,1)"
                                                name="extra_gigs_delivery[]">
                            ...
                            <div id="add_extra_gig">
                                <input type="hidden" name="table_content" id="table_content" value="<?php echo $table_content_row_id; ?>">
                            </div>
                    ...
                    <small class="error_msg help-block extra_gigs_validate" style="display: none;">
                        <?php echo (!empty($user_language[$user_selected]['lg_please_enter_the_price_for_extra_gig'])) ? $user_language[$user_selected]['lg_please_enter_the_price_for_extra_gig'] : $default_language['en']['lg_please_enter_the_price_for_extra_gig']; ?>
                    </small>

                    <small class="error_msg help-block extra_gigs_gig_name" style="display: none;">
                        <?php echo (!empty($user_language[$user_selected]['lg_please_enter_the_gig_name'])) ? $user_language[$user_selected]['lg_please_enter_the_gig_name'] : $default_language['en']['lg_please_enter_the_gig_name']; ?>
                    </small>

                    <div class="form-group clearfix">
                        <label class="label-title m-t-10">
                            <?php echo (!empty($user_language[$user_selected]['lg_super_fast_delivery'])) ? $user_language[$user_selected]['lg_super_fast_delivery'] : $default_language['en']['lg_super_fast_delivery']; ?>
                        </label>
                        ...
                        <div class="delivery-block clearfix">
                            <div class="checkbox checkbox-primary checkbox-inline pull-left">
                                <input type="checkbox" name="super_fast_delivery" class="validdays" id="super_fast_delivery" value="yes" <?php if (
                                    $basic_details['super_fast_delivery'] == 'yes') {
                                    echo "checked";
                                } ?> >
                                <label for="super_fast_delivery">&nbsp; </label>
                            </div>

                            <span class="super-fast">
                                <?php echo (!empty($user_language[$user_selected]['lg_super_fast'])) ? $user_language[$user_selected]['lg_super_fast'] : $default_language['en']['lg_super_fast']; ?>
                            </span>

                            <div class="name-block2 superfast-block">
                                <span class="name-input2">
                                    <input name="super_fast_delivery_desc"
                                         id="super_fast_delivery_desc"
                                         class="form-control gig-name"
                                         placeholder="<?php echo (!empty($user_language[$user_selected]['lg_i_can_deliver_the_gigs_in_2_days'])) ? $user_language[$user_selected]['lg_i_can_deliver_the_gigs_in_2_days'] : $default_language['en']['lg_i_can_deliver_the_gigs_in_2_days']; ?>"
                                         type="text"
                                         value="<?php echo (!empty($basic_details['super_fast_delivery_desc'])) ? $basic_details['super_fast_delivery_desc'] : ''; ?>">
                                </span>
                                <span class="currency">
                                    <?php
                                    ...
                                    ?>
                                    for <?php echo $rate_symbol; ?>
                                    <span class="currency-group">
                                        <input type="text"
                                            class="form-control amount numberonly validdays"
                                            name="super_fast_charges"
                                            value="<?php echo ($superfast_delivery_rate != 0) ? $superfast_delivery_rate : ''; ?>">
                                    </span>
                                    <?php echo (!empty($user_language[$user_selected]['lg_in'])) ? $user_language[$user_selected]['lg_in'] : $default_language['en']['lg_in']; ?>
                                    <input
                                        type="text" onkeyup="extra_gig_days(this,2)"
                                        onfocusout="inputfocusout(this)" onmouseup="extra_gig_days(this,2)"
                                        class="form-control amount2 numberonly" maxlength="2"
                                        name="super_fast_delivery_date" id="super_fast_delivery_date"
                                        value="<?php echo $basic_details['super_fast_delivery_date']; ?>">
                        ...
                        <small class="error_msg help-block super_fast_error" style="display: none;">
                            <?php echo (!empty($user_language[$user_selected]['lg_please_enter_a_description'])) ? $user_language[$user_selected]['lg_please_enter_a_description'] : $default_language['en']['lg_please_enter_a_description']; ?>
                        </small>

                        <small class="error_msg help-block super_fast_priece_error" style="display: none;">
                            <?php echo (!empty($user_language[$user_selected]['lg_please_enter_a_super_fast_price'])) ? $user_language[$user_selected]['lg_please_enter_a_super_fast_price'] : $default_language['en']['lg_please_enter_a_super_fast_price']; ?>
                        </small>
                    ...
                    <div class="form-group select-condition clearfix">
                        ...
                        <label class="label-title"><?php echo (!empty($user_language[$user_selected]['lg_how_are_you_planning_to_work_with_the_buyer'])) ? $user_language[$user_selected]['lg_how_are_you_planning_to_work_with_the_buyer'] : $default_language['en']['lg_how_are_you_planning_to_work_with_the_buyer']; ?>
                            ? <span class="required">*</span>
                        </label>
                        ...
                        <div class="buyer-option">
                            ...
                            <div class="radio radio-primary">
                                <input type="radio" value="1" id="radio4"
                                       name="work_option" <?php if ($basic_details['work_option'] == 1) {
                                    echo 'checked=""';
                                } ?> >
                                <label for="radio4">
                                    <?php echo (!empty($user_language[$user_selected]['lg_on'])) ? $user_language[$user_selected]['lg_on'] : $default_language['en']['lg_on']; ?>
                                    -<?php echo (!empty($user_language[$user_selected]['lg_site'])) ? $user_language[$user_selected]['lg_site'] : $default_language['en']['lg_site']; ?>
                                </label>
                            </div>

                            <small class="error_msg help-block work_option_error" style="display: none;">
                                <?php echo (!empty($user_language[$user_selected]['lg_please_select_any_option'])) ? $user_language[$user_selected]['lg_please_select_any_option'] : $default_language['en']['lg_please_select_any_option']; ?>
                            </small>
                        </div>
                    </div>

                    <div class="form-group item-description clearfix">
                        <label class="label-title"> <?php echo (!empty($user_language[$user_selected]['lg_what_do_you_need_from_the_buyer_to_get_started'])) ? $user_language[$user_selected]['lg_what_do_you_need_from_the_buyer_to_get_started'] : $default_language['en']['lg_what_do_you_need_from_the_buyer_to_get_started']; ?>
                            <span class="required">*</span>
                        </label>
                        <textarea rows="4"
                              placeholder="<?php echo (!empty($user_language[$user_selected]['lg_explain_what_you_will_need_from_the_buyer_to_deliver_the_world'])) ? $user_language[$user_selected]['lg_explain_what_you_will_need_from_the_buyer_to_deliver_the_world'] : $default_language['en']['lg_explain_what_you_will_need_from_the_buyer_to_deliver_the_world']; ?>..."
                              name="requirements" id="requirements"
                              class="form-control"><?php echo $basic_details['requirements']; ?>
                        </textarea>
                    ...
                    <div class="form-group agreement clearfix">
                        ...
                        <span class="sitename2">
                            ...
                            <a href="<?php echo base_url() . 'tandc' ?>" target="_blank" class="chk-link">  T&amp;Cs </a>
                            <small class="error_msg help-block terms_conditions_error" style="display: none;">
                                <?php echo (!empty($user_language[$user_selected]['lg_please_accept_terms'])) ? $user_language[$user_selected]['lg_please_accept_terms'] : $default_language['en']['lg_please_accept_terms']; ?> & <?php echo (!empty($user_language[$user_selected]['lg_conditions'])) ? $user_language[$user_selected]['lg_conditions'] : $default_language['en']['lg_conditions']; ?>
                            </small>
                        </span>
                    </div>
                    ...
                    <a href="javascript:void(0)" onclick="sell_services_update()" class="btn btn-yellow sell_service_submit">
                        <?php echo (!empty($user_language[$user_selected]['lg_post_your_ad'])) ? $user_language[$user_selected]['lg_post_your_ad'] : $default_language['en']['lg_post_your_ad']; ?>
                    </a>
                </form>
            </div>
                ...
                <div class="image-editor">
                    ...
                    <div class="row resize-bottom">
                        ...
                        <div class="col-md-4 text-right">
                            <button class="btn btn-primary export"><?php echo (!empty($user_language[$user_selected]['lg_done'])) ? $user_language[$user_selected]['lg_done'] : $default_language['en']['lg_done']; ?></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>
                        <?php echo (!empty($user_language[$user_selected]['lg_youtube_link'])) ? $user_language[$user_selected]['lg_youtube_link'] : $default_language['en']['lg_youtube_link']; ?>:
                    </label>
                    <input class="form-control" type="url" name="" id="youtube_url_link" value="<?php echo $link; ?>"/>
                ...
                <div class="form-group">
                    <label>
                        <?php echo (!empty($user_language[$user_selected]['lg_vimeo_link'])) ? $user_language[$user_selected]['lg_vimeo_link'] : $default_language['en']['lg_vimeo_link']; ?>:
                    </label>
                    <input class="form-control" type="url" name="" id="vimeo_url_link" value="<?php echo $vimeo_link; ?>"/>
                    <span id="error_vimeo_link" class="error_msg">  </span>
                </div>

                <button type="button" class="btn btn-primary logon-btn" id="third_party_videos" value="submit">
