                ...
                <div class="user-block">
                    ...
                    <div class="user-details">
                        <div class="user-name-block">
                            ...
                            <input type="button" name="cancel" id="cancel" value="cancel" style="display: none">
                            <h3 id="uname-edit" class="user-name">
                                <?php echo ucfirst($profile['fullname']); ?>
                            </h3>
                        ...
                        <?php if (!empty($profile['language'])) { ?>
                            <div class="user-language">
                                ...
                                : <span id="language_list"><?php echo ucfirst($profile['language']); ?></span> <input
                                        type="hidden" value="" id="lang_speaks">
                                </span>
                            </div>
                        <?php } ?>
                    </div>
                        ...
                        <div class="col-md-9 col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>
                                            <?php echo (!empty($user_language[$user_selected]['lg_current_password'])) ? $user_language[$user_selected]['lg_current_password'] : $default_language['en']['lg_current_password']; ?>
                                        </label>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>
                                            <?php echo (!empty($user_language[$user_selected]['lg_new_password'])) ? $user_language[$user_selected]['lg_new_password'] : $default_language['en']['lg_new_password']; ?>
                                        </label>
                            ...
                            <div class="text-center">
                                <button name="form_submit" class="btn btn-primary save-btn" value="true" type="submit">
