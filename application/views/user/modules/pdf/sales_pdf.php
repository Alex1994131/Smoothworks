...
<table id="titles">
    ...
    <tr>
        <th align="center"
            colspan="7"><?php echo (!empty($user_language[$user_selected]['lg_gigs_sales_reports'])) ? $user_language[$user_selected]['lg_gigs_sales_reports'] : $default_language['en']['lg_gigs_sales_reports']; ?></th>
    </tr>
    </thead>
    <tbody>
    <tr>
