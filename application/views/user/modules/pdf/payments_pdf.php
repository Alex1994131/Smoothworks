...
<table id="titles">
    ...
    <tr>
        <th align="center"
            colspan="5"><?php echo (!empty($user_language[$user_selected]['lg_gigs_payments_reports'])) ? $user_language[$user_selected]['lg_gigs_payments_reports'] : $default_language['en']['lg_gigs_payments_reports']; ?></th>
    </tr>
    </thead>
    <tbody>
    <tr>
...
<table id="sales">
    ...
    <tr>
        <td colspan="5"
            align="right"><?php echo (!empty($user_language[$user_selected]['lg_total_amount'])) ? $user_language[$user_selected]['lg_total_amount'] : $default_language['en']['lg_total_amount']; ?></td>
