...
<footer class="footer text-right">
    ...
    <div class="version">Version <?php echo $this->session->userdata('version'); ?></div>
</footer>
...
<?php
if ($module == 'settings' || $module == 'language' || $module = 'membership') {
...
<?php if ($module == 'membership') { ?>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/pages/admin/membership.js"></script>
<?php } ?>
