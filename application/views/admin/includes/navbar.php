    ...
    <div class="header-left">
        <div class="text-center">
            ...
            <a href="<?php echo base_url() . 'admin' ?>"
               class="logo web-logo text-ellipsis"><span><?php echo $this->website_name ?></span></a>
        </div>
    </div>
            ...
            <ul class="nav navbar-nav navbar-right pull-right">
                <li class="dropdown product-noti">
                    <a href="#" data-target="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                        <i class="fa fa-bell-o" aria-hidden="true"></i> <span class="badge badge-xs badge-danger"
                ...
                <li class="dropdown">
                    ...
                    if (!empty($result['profile_thumb'])) {
                        $image = base_url() . $result['profile_thumb'];
                    }
                    ?>
                    <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img
                                src="<?php echo $image; ?>" alt="user-img" class="img-circle"> </a>
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo base_url() . 'admin/profile' ?>">Profile</a></li>
                        <li><a href="<?php echo base_url() . 'admin/settings' ?>">Settings</a></li>
                        <li>
                            <a href="<?php echo base_url() . 'admin/new_updates' ?>">Updates <?php if ($this->session->userdata('updates') != '') {
                                    echo '<span class="badge badge-xs badge-danger" id="update_count">1</span>';
                                } ?></a></li>
