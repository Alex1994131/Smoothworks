                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
                            <ul class="nav nav-tabs navtab-bg nav-justified">
                                <li class="active tab"><a href="<?php echo base_url() . 'admin/financial/affiliate'; ?>">Affiliate</a></li>
                            ...
                            <div class="tab-content">
                                <div id="affiliate" class="tab-pane active">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h4 class="page-title m-b-20 m-t-0">Affiliate</h4>
                                        </div>
                                        <div class="col-sm-6">
                                            <h4 class="page-title m-b-20 m-t-0 m-r-10" style="text-align: right; ">
                                                ...
                                                <?php 
                                                    ...
                                                    for($i = 0; $i<count($list); $i++) { 
                                                        $all_affiliate_fee += $list[$i]['price'];
                                                    }
                                                    
                                                    echo $all_affiliate_fee;
                                                ?>
                                            </h4>
                                        </div>
                                    </div>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php 
                                                                            ...
                                                                            $query = $this->db->query("select * from bids where id = $award_bid_id");
                                                                            $result = $query->result_array();
                                                                            $bid_user_id = $result[0]['user_id'];

                                                                            $query = $this->db->query("select * from members where USERID = $bid_user_id");
                                                                            $result = $query->result_array();
                                                                            $username = $result[0]['fullname'];

                                                                            echo 'User obtained affiliate fee, ' . $username .' completed project(' . $item['project_title'] . ')';
                                                                        ?>
                                                                    </td>
