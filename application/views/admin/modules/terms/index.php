            ...
            <div class="row">
                ...
                <div class="col-sm-4 text-right m-b-20">
                    ...
                    if (!empty($lists)) {
                        ...
                        if ($count < 2) {
                            ?>
                            <a href="<?php echo base_url('admin/dashboard/termcreate/'); ?>"
                               class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add Menu</a>
                            <?php
                        }
                    } else { ?>
                        <a href="<?php echo base_url('admin/dashboard/termcreate/'); ?>" class="btn btn-primary btn-sm">
                                ...
                                foreach ($lists as $row) {
                                    ...
                                    if (!empty($_id)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo base_url('admin/dashboard/termsedit/' . $_id); ?>"
                                                   class="on-default view-row table-action-btn" title="Edit">
                            ...
                            if (!empty($lists)) {
                                ...
                                <td colspan="4">
                                    <form method="post" id="multi_deletes_form"
                                          action="<?php echo base_url(); ?>gigs/multiple_delete"><input
                                                id="multi_Delete" type="hidden" name="multi_Delete"><input type="submit"
                                                                                                           name=""
