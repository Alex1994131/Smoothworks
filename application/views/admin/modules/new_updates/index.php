        ...
        <div class="container">
            <div class="row">
                ...
                <div class="pull-right">
                    ...
                    <button class="btn btn-success hidden" id="download"><i class="fa fa-download m-r-5"></i> New
                        updates available
                    </button>
            ...
            <div class="backups">
                <div class="row">
                    ...
                    <div class="col-sm-4 text-right m-b-20">
                        <a class="btn btn-success pull-right backup_btn"
                           href="<?php echo base_url(); ?>admin/new_updates/backup_db"><i
                                    class="fa fa-database m-r-5"></i> Backup Files & DB</a>
                        <button class="btn btn-info pull-right loading" style="display: none"><i
                                    class="fa fa-spinner fa-spin fa-fw m-r-5"></i> Please wait backup on process
                        </button>
                    </div>
                </div>
            </div>
