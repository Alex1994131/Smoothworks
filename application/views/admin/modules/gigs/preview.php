                                ...
                                <div class="view-left">
                                    ...
                                    <div class="owl-carousel img-carousel owl-theme owl-loaded">
                                        <div class="owl-stage-outer">
                                            <div class="owl-stage"
                                                 style="transform: translate3d(0px, 0px, 0px); transition: 0s; width: 640px;">
                                                <div class="owl-item active" style="width: 640px; margin-right: 0px;">
                                                    <div class="item">

                                                        <?php if (!empty($details['gig_images'][0]['image_path'])) { ?>
                                                            <img class="img-responsive"
                                                                 src="<?php echo base_url(); ?><?php echo $details['gig_images'][0]['image_path']; ?>"
                                                    ...
                                                    <li>
                                                        <div class="delivery-block clearfix">
                                                            <p>
                                                                ...
                                                                <span class="extra-input pull-right">  for  <span
                                                                            class="currency_symbol"><?php echo $currency_sign; ?><?php echo (!empty($extragigs['extra_gigs_amount'])) ? $extragigs['extra_gigs_amount'] : ''; ?></span> in <span
                                                                            class="delivery_days"> <?php echo (!empty($extragigs['extra_gigs_delivery'])) ? $extragigs['extra_gigs_delivery'] : ''; ?> day </span></span>
                                                        </div>
                                                    </li>
                                                <?php } ?>
                                    ...
                                    <div class="col-md-12">
                                        <form action="<?php echo base_url(); ?>admin/gig_activate" method="POST">
                                            <label class="radio-inline">
                                                ...
                                                <input type="radio" name="gig_active"
                                                       value="0" <?php echo $checkced1; ?>>Active
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="gig_active"
                                                       value="1" <?php echo $checkced2; ?>>Inactive
                                            </label>
