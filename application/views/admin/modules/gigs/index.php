                                ...
                                if (!empty($list)) {
                                    ...
                                    foreach ($list as $item) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="gig-img">
                                                    <img alt="<?php echo $item['title']; ?>" src="<?php echo $image; ?>">
                                                </span>
                                                <h2 class="text-ellipsis">
                                                    <a href="<?php echo base_url() . "admin/gigs/gig_preview/" . md5($item['gig_id']); ?>" target="_blank">
                                            ...
                                            <td class="toogle_switch text-right">
                                                ...
                                                $new = '';
                                                ?>
                                                <input type="checkbox" <?php echo $new; ?> <?php echo $status; ?>
                                                       class="alert-status switch" id="<?php echo $item['gig_id']; ?>"
                                                       data-size="normal" name="my-checkbox" data-on-text="on"
                                                       data-off-text="off">
                                                <a href="javascript:void(0)"
                                                   onclick="admin_delete_gigs(<?php echo $item['gig_id']; ?>)"
