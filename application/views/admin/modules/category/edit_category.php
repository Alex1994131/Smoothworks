                        ...
                        <form id="admin_add_cat" action="<?php echo base_url() . 'admin/category/edit_category/' . $list['CATID']; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="category_name" placeholder="Enter Category Name "
                                       value="<?php if (!empty($list['name'])) {
                                           echo $list['name'];
                                       } ?>" class="form-control only_alphabets" id="category_name" required>
                            </div>
                            <input type="hidden" name="catagory_id" value="<?php if (!empty($list['CATID'])) {
                                echo $list['CATID'];
                            } ?>" id="catagory_id">
                            <div class="form-group">
