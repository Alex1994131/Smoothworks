                                            ...
                                            <td>
                                                <?php 
                                                    if($item['remark'] == 'membership') {
                                                        echo 'User purhcased membership. but it is declined';
                                                    }
                                                    else if($item['remark'] == 'milestone') {
                                                        echo 'User create Milestone and pay price for the project. but it is declined';
                                                    }
                                                    else if($item['remark'] == 'project fee') {
                                                        echo 'User pay the fee of project during accept the project award. but it is declined';
                                                    }
                                                    else if($item['remark'] == 'withdraw') {
                                                        echo 'User suggest the withdraw of his balances. but it is declined';
                                                    }
                                                    else if($item['remark'] == 'project commission') {
                                                        echo 'User obtained project commission as complete the project. but it is declined';
                                                    }
                                                    else if($item['remark'] == 'affiliate fee') {
                                                        echo 'User obtained affiliate fee, user you suggested get the project commission. but it is declined';
                                                    }
                                                ?>
                                            </td>
