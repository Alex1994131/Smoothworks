    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-box">
                        <form id="admin_add_ip" action="<?php echo base_url() . 'admin/policy_settings/create'; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="policy_description" maximumlength="250" class="form-control"
                                       id="policy_description" required>
                            </div>
