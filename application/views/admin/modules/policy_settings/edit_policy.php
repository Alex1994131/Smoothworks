    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-box">
                        <form id="admin_add_ip"
                              action="<?php echo base_url() . 'admin/policy_settings/edit/' . $list['id']; ?>"
                              enctype="multipart/form-data" method="post">
                            <div class="form-group">
                                <label for="policy_name">Placeholder Name</label>
                                <input type="text" name="policy_name" class="form-control only_alphabets"
                                       value="<?php echo $list['policy_name']; ?>" id="policy_name" required>
                            </div>
                            <div class="form-group">
                                ...
                                <div id="avatar-view" class="avatar" style="width: 200px; height: 200px;">
                                    ...
                                    >
                                        <img src="<?php echo base_url($list['policy_raw_image']); ?>" width="200"
                                             height="100">
                                        <input type="file" name="dgt[]"/>
                                    </div>
                                </div>

                                <input type="hidden" value="<?php echo $list['policy_raw_image']; ?>" name="imageurl"
                                       id="imageurl">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="policy_description"
                                       value="<?php echo $list['policy_terms']; ?>" maximumlength="250"
                                       class="form-control" id="policy_description" required>
                            </div>

                            <div class="form-group m-b-0 m-t-30">
                                <button class="btn btn-primary" name="form_submit" value="submit" type="submit">Submit
                                </button>
                                <a href="<?php echo base_url() . 'admin/policy_settings' ?>"
                                   class="btn btn-default m-l-5">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
