    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-box">
                        <form id="admin_add_cat"
                              action="<?php echo base_url() . 'admin/user/edit_user/' . $list['USERID']; ?>"
                              method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="user_fullname">Name</label>
                                <input type="text" name="user_fullname" readonly placeholder="Enter Full name"
                                       value="<?php if (!empty($list['fullname'])) {
                                           echo $list['fullname'];
                                       } ?>" class="form-control" id="user_fullname">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="user_email" placeholder="Enter Email"
                                       value="<?php if (!empty($list['email'])) {
                                           echo $list['email'];
                                       } ?>" class="form-control" id="user_email" readonly>
                            </div>
                            <div class="form-group">
                                <label for="amount">Username</label>
                                <input type="text" name="user_username" placeholder="Enter Username"
                                       value="<?php if (!empty($list['username'])) {
                                           echo $list['username'];
                                       } ?>" class="form-control" id="user_username" readonly>
                            </div>
                            <div class="form-group">
