                                ...
                                foreach ($lists as $row) {
                                    ...
                                    if (!empty($_id)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="<?php echo base_url('admin/footer_submenu/edit/' . $_id); ?>"
                                                   class="on-default view-row table-action-btn" title="Edit"><i
                                                            class="mdi mdi-pencil text-success"></i></a>&nbsp;
                                                <a href="javascript:void(0)"
                                                   class="on-default remove-row table-action-btn" title="Delete"
                                                   id="Onremove_<?php echo $_id; ?>"
                                                   onclick="delete_footer_submenu(<?php echo $_id; ?>);"><i
