    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="card-box">
                        <form class="form-horizontal" id="add_submenu"
                              action="<?php echo base_url('admin/footer_submenu/create'); ?>" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="page_desc"
                                              id="ck_editor_textarea_id"></textarea>
