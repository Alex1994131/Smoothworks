                ...
                <div class="col-lg-3 col-sm-6">
                    <a href="<?php echo base_url() . 'admin/orders'; ?>">
                        <div class="dash-widget">
                            ...
                            <div class="text-muted m-t-5">Total Transactions</div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <a href="<?php echo base_url() . 'admin/completed_orders'; ?>">
                        <div class="dash-widget">
                            ...
                            <div class="text-muted m-t-5">Completed Transactions</div>
                        </div>
                    </a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="card-box">
                        ...
                        <h4 class="text-dark header-title m-t-0 m-b-20">Recent Transactions</h4>
                                ...
                                if (!empty($recent_orders)) {
                                    foreach ($recent_orders as $recent) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date('d M Y', strtotime(str_replace('-', '/', $recent['created_date']))); ?></td>
                                            <td><?php echo $recent['txn_id']; ?></td>
                            ...
                            <table class="table">
                                ...
                                if (!empty($popular_orders)) {
                                    foreach ($popular_orders as $popular_order) {
                                        ...
                                        ?>
                                        <tr>
                                            <td><img src="<?php echo $image; ?>" class="gig-img"
                                                     alt="<?php echo str_replace('-', ' ', $popular_order['title']); ?>">
                                            </td>
