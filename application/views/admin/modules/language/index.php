            ...
            <div class="row">
                ...
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="card-box">
                        ...
                        <form class="form-horizontal" id="" onsubmit="return language_validation();" action=""
                              method="POST">
                            ...
                            <div class="tab-pane active">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" id="language" name="language" value=""
                                               class="form-control only_alphabets">

                                        <small class="error_msg help-block language_error" style="display: none;">Please
                                            enter a language</small>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <small class="error_msg help-block value_error" style="display: none;">Please
                                            enter a value</small>
                            ...
                            <div class="m-t-30 text-center">
                                ...
                                <button name="form_submit" type="submit" class="btn btn-primary center-block"
                                        value="true">Save
                                </button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($row['language_value'] == 'en') {
                                                ...
                                                <span id="lang_status<?php echo $row['id']; ?>"
                                                      data-status="<?php echo $row['status']; ?>"
                                                      style="cursor: pointer;"
                                                      onclick="change_status(<?php echo $row['id']; ?>)"
                                                      class="label label-<?php echo $status; ?>"><span
                                                            id="texts<?php echo $row['id']; ?>"><?php echo $stst; ?></span></span>


                                            <?php } ?>

                                        </td>
                                        <td><input type="radio" <?php echo $style; ?> class="default_lang"
                                                   value="1" <?php if ($row['default_language'] == '1') echo 'checked'; ?>
                                                   name="default_language" data-id="<?php echo $row['id']; ?>"
                                                   id="default_language<?php echo $row['id']; ?>"></td>
