<div class="content-page">
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title m-b-20 m-t-0">Add Other Language Keywords</h4>
                </div>
            </div>
            <div>
                <div class="panel">
                    <div class="panel-body">
                        <div class="table-responsive">
                            <form action="<?php echo base_url() . 'admin/language_management_controller/update_multi_language/'; ?>"
                                  onsubmit="update_multi_lang();" method="post" id="form_id">
                                ...
                                <table class="table table-striped table-actions-bar datatable">
                                    ...
                                    foreach ($language_list as $keyword) {
                                        ...
                                        if (!empty($active_language)) {
                                            foreach ($active_language as $row) {
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" class="form-control"
                                                           name="<?php echo $lg_language_name; ?>[<?php echo $language_key; ?>]"
                                                           value="<?php echo $value; ?>" <?php echo $readonly; ?> ></td>
                                            ...
                                            <tr>
                                                <td colspan="10"><p class="text-danger text-center m-b-0">No Records
                                                        Found</p></td>
                                            </tr>
                                        <?php } ?>
                                        </tr>
