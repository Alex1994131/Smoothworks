                            ...
                            <div>
                                ...
                                <div class="tab-content">
                                    <div id="single_data" class="tab-pane active">
                                        ...
                                        <form class="form-horizontal" id="" onsubmit="return keyword_validation();"
                                              action="" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="page_name" name="page_name" value=""
                                                           class="form-control">
                                                    <small class="error_msg help-block keyword_error"
                                                           style="display: none;">Please enter a page name</small>
                                                </div>
                                            </div>
