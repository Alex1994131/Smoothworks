            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-box">
                        ...
                        <form id="admin_edit_ip" action="<?php echo base_url() . 'admin/review/edit/' . $list['id']; ?>"
                              method="post">
                            <div class="form-group">
                                <label for="gigs_title"> Gigs Title </label>
                                <input type="text" name="gigs_title" class="form-control" id="gigs_title"
                                       value="<?php if (!empty($list['title'])) {
                                           echo $list['title'];
                                       } ?>" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="review" class="form-control" id="gigs_title"
                                       value="<?php if (!empty($list['comment'])) {
                                           echo $list['comment'];
                                       } ?>" readonly>
                            </div>
                            <div class="form-group">
