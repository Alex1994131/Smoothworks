    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-box">
                        <form id="admin_add_client"
                              action="<?php echo base_url() . 'admin/client/edit/' . $list['id']; ?>" method="post"
                              enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="client_name">Client Url</label>
                                <input type="url" value="<?php if (!empty($list['client_name'])) {
                                    echo $list['client_name'];
                                } ?>" name="client_name" placeholder="https://www.dreamguys.co.in" value=" "
                                       class="form-control only_alphabets" id="client_name">
                            </div>
                            <div class="form-group">
                                ...
                                <div id="avatar-view" class="avatar" style="width: 200px; height: 200px;">
                                    ...
                                    >
                                        <img src="<?php echo base_url($list['client_raw_image']); ?>" width="200"
                                             height="100">
                                        <input type="file" name="dgt[]"/>
                                    </div>
                                </div>

                                <input type="hidden" value="<?php echo $list['client_raw_image']; ?>" name="imageurl"
                                       id="imageurl">
