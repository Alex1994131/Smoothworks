    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-box">
                        <form id="admin_add_client" action="<?php echo base_url() . 'admin/client/create'; ?>"
                              method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="ip_addr">Client Url</label>
                                <input type="url" name="client_name" placeholder="https://www.dreamguys.co.in"
                                       class="form-control" id="client_name" required>
                            </div>
                            <div class="form-group">
