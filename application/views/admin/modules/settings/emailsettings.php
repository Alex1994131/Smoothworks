    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="card-box">
                        <form class="form-horizontal" id="form_emailsetting" action="" method="POST"
                              enctype="multipart/form-data">
                            <div id="email_settings" class="tab-pane active">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Email From Address</label>
                                    <div class="col-sm-9">
                                        <input type="text" id="website_name" name="email_address"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="email_tittle" name="email_tittle"
                                               value="<?php if (isset($email_tittle)) echo $email_tittle; ?>"
