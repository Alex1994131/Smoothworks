                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="smtp_host" name="smtp_host"
                                               value="<?php if (isset($smtp_host)) echo $smtp_host; ?>"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="smtp_port" name="smtp_port"
                                               value="<?php if (isset($smtp_port)) echo $smtp_port; ?>"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="smtp_user" name="smtp_user"
                                               value="<?php if (isset($smtp_user)) echo $smtp_user; ?>"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="smtp_pass" name="smtp_pass"
                                               value="<?php if (isset($smtp_pass)) echo $smtp_pass; ?>"
                                               class="form-control">
                                    </div>
                                </div>
                            </div>
