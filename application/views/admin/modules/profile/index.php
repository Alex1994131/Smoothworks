                ...
                <div class="col-md-12 col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <form id="admin_profile" action="<?php echo base_url($theme . '/profile'); ?>" method="POST"
                                        ...
                                        <div class="col-sm-7">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="uploader"><input type="file" class="form-control"
                                                                                 name="admin_profile" id="imageonly">
                                                    </div>
                    ...
                    <div class="panel m-b-0">
                        <div class="panel-body">
                            ...
                            <form id="pass-val" action="<?php echo base_url($theme . '/profile/password'); ?>"
                                  method="post">
                                <div class="form-group">
                                    <div class="row">
                                ...
                                <div class="form-group m-t-20 m-b-0">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <button name="form_submits" type="submit" class="btn btn-primary"
                                                    value="true">Save password
                                            </button>
                                        </div>
                                    </div>
                                </div>
